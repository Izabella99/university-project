...
if ( isset($_SESSION["username"])&&($_SESSION["kiaz"]=="diak")){ //csak diak tolthet fel
    ...
    $targetfolder =  'uploads/szakdolgozat/'  ; //a mappa amibe kerül a fájl
    $filename = $_SESSION["username"]. '_SZD.' . $extension; // a fájl nevének felépítése
      ...
      if($dbcon->connect_error){ //sikertelen csatlakozas
          ...
          if(mysqli_query($dbcon,$sql)){ 
            ...
            if($count == 1) {
                ...
                $sql2="UPDATE szakdolgozat SET Tartalom ='$fajlneve' WHERE CNP='$CNP'";
